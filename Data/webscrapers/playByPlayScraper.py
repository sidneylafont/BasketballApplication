...
def main():
    '''
    scrapes basketball-reference for all the play-by-play stats for active players
    '''
    ...
    for l in letters:
        ...
        for p in tbodyLetterSoup.findAll("strong"):
            ...
            startTable = playerSoupStr.find("<tr id=\"pbp.")
    ...
    with open("csvs/play_by_play.csv", mode='w') as player_per_game:
